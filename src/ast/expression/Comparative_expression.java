...
public class Comparative_expression extends AbstractExpression  {
	...
	public Comparative_expression(Expression left, String operador, Expression right) {
		super();
	...
	public Comparative_expression(Object left, Object operador, Object right) {
		super();
    ...
    public String toString() {
        return "Comparative_expression{" + " left=" + this.getLeft() + " operador=" + this.getOperador() + " right=" + this.getRight() + "}";
    }
