...
*/
public class Logical_expression extends AbstractExpression  {
	...
	public Logical_expression(Expression left, String operador, Expression right) {
		super();
	...
	public Logical_expression(Object left, Object operador, Object right) {
		super();
    ...
    public String toString() {
        return "Logical_expression{" + " left=" + this.getLeft() + " operador=" + this.getOperador() + " right=" + this.getRight() + "}";
    }
