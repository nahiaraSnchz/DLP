...
/*
	...
	expression -> 
*/
public class Return_list extends AbstractExpression  {
	...
	public Return_list(Expression left, Expression right) {
		super();
	...
	public Return_list(Object left, Object right) {
		super();
    ...
    public String toString() {
        return "Return_list{" + " left=" + this.getLeft() + " right=" + this.getRight() + "}";
    }
