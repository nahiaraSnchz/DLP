...
/*
	Cast_expression: expression -> type:type expression:expression
	expression -> 
*/
public class Cast_expression extends AbstractExpression  {
	...
	public Cast_expression(Type type, Expression expression) {
		super();
	...
	public Cast_expression(Object type, Object expression) {
		super();
    ...
    public String toString() {
        return "Cast_expression{" + " type=" + this.getType() + " expression=" + this.getExpression() + "}";
    }
